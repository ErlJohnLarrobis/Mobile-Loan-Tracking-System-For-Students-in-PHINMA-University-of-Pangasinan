    ...
    <div class="offcanvas-body p-0">
      <nav class="navbar-dark">
        <ul class="navbar-nav">
          ...
          <li>
            <a href="userstudentlist.php" class="nav-link px-3">
      ...
      <div class="row">
        <div class="col-md-12 mb-3">
          <div class="card">
            ...
            <div class="card-body">
              <article>
                  Hi, PHINMA Ed Student!<br>
                  STUDENT LOAN APPLICATION PROCESS<br><br>

                  Step 1: Fill out this Form and attach all required documents (preferably using your PHINMAEd account).<br><br>

                  Step 2: Wait for the verification message from CSDL. Please expect a contact within 1 to 2 days upon application.<br><br>

                  Step 3: Check your email, preferably your PHINMAEd e-mail, for the electronic permit once approved.<br><br>

                  NOTES:
                  For faster transactions, you are required to render PARTIAL PAYMENT WITHIN THREE (3) DAYS after filing this application. From the date of application, kindly wait within 1-2 days for the payment details and the verification message to be given via TEXT MESSAGE or CALL. Please be informed that our team may CANCEL or VOID your loan application if partial payment was not made. Should this happen, you may RE-APPLY for another student loan for the examination within the prescribed period.<br><br>

                  For students with previous student loans, please be informed that you are required to settle your former loans first before applying for the second semester enrollment student loan.<br><br>

                  Please fill-out this form only ONCE. You may contact us in our Student Loan Hotline (0995 115 5303) to verify your application and for any inquiries you may have regarding your student loan application or existing balance.<br><br><br>
                </article>
              <form action="db_conn.php" method="post">
                ...
                <div class="mb-3">
                  ...
                  <input type="hidden" name="pending" value="Pending" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
