...
<body onload="startTime()">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color:#003d13;">
    <div class="container-fluid">
      ...
      <a class="navbar-brand me-auto ms-lg-0 ms-3 text-uppercase fw-bold text-white">STUDENT LOAN LIST</a>
  ...
  <main class="mt-5 pt-3">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 mb-3">
          <button type="button" class="btn btn-warning" onclick="window.location.href='studentlist.php';"><i class="bi bi-backspace-fill"></i> Go Back</button><br>
          <div class="card">
            <div class="card-header">
              <span><i class="bi bi-table me-2"></i></span> Account
            </div>
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table id="example" class="table table-striped" style="width: 100%">
                  <div class="widget-body">
                    <div class="row">
                      <?php $sql = 'SELECT * FROM users WHERE user_name="'.$var_value.'"';
                    ...
                    $resultCheck = mysqli_num_rows($result);
                      ...
                      <div class="col-sm-5 text-primary">:<b> <?php echo $row['name'];?></b></div>
                      <div class="col-sm-1">Student #</div>
                      <div class="col-sm-5 text-primary">: <b> <?php echo $row['user_name'];?></b></div>
                    </div>
                    <div class="row">
                      <div class="col-sm-1">Course</div>
                      <div class="col-sm-5 text-primary">: <?php echo $row['course'];?></div>
                      <div class="col-sm-1">Year Level</div>
                      <div class="col-sm-5 text-primary">: <?php echo $row['yearlvl'];?></div>
                    </div>
                    <div class="row">
                      <div class="col-sm-1">Status</div>
                      <div class="col-sm-5 text-primary">: <?php echo $row['status'];?>
                      </div>
                      <div class="col-sm-1">Section</div>

                      <div class="col-sm-5 text-primary">: <span id="student_parent_section"><?php echo $row['section'];?></span></div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5 text-primary">: <?php echo $row['sy'];?></div>
                      <div class="col-sm-1">Semester</div>
                      <div class="col-sm-5 text-primary">: <?php echo $row['semester'];?></div>
                    </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td></td>
                      <td></td>
                      <form class="form-login" action="userpayment.php" method="POST">
                      <td><input type="number" name="fee"></td>
                      <td><input type="date" name="partialdate"></td>
                      
                    </tr>
                    <tr>
                    
                      <?php $sql = 'SELECT * FROM approve_tbl WHERE student_num="'.$var_value.'"';
                    $result = mysqli_query($conn,$sql); 
                    $resultCheck = mysqli_num_rows($result);
                    ...
                    <input type="hidden" name="student_num" value="<?php echo $row['student_num'];?>">
                    <input type="hidden" name="fullname" value="<?php echo $row['fullname'];?>">
                    <input type="hidden" name="Amount_loan" value="<?php echo $row['Amount_loan'];?>">
                    <input type="hidden" name="date_loan" value="<?php echo $row['date_loan'];?>">
                    <input type="hidden" name="partial" value="<?php echo $row['partial'];?>">
                    <input type="hidden" name="date_loan" value="<?php echo $row['date_loan'];?>">
                    <input type="hidden" name="Balance" value="<?php echo $row['Balance'];?>">
                      ...
                      <td><?php echo $row['partialdate'];?></td>
    ...
    <div class="text-center">
      ...
      <button type="button" class="btn btn-success">Delete Student</button>
    </div>
</form>
  </main>
