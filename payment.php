        ...
        <div class="col-md-12 mb-3">
          ...
          <div class="card">
            <div class="card-header">
              <span><i class="bi bi-bell-fill"></i></span> Payment
            </div>
            <div class="input-group mb-3">
              <span class="input-group-text" id="inputGroup-sizing-default">First Name</span>
              <textarea style="resize: none; height: 10px;" class="form-control" id="floatingTextarea" disabled><?php $sql = 'SELECT * FROM payment_tbl WHERE Lname="'.$var_value.'"';
            ...
            <div class="input-group mb-3">
              <a href="files/resibo.jpg" target="_blank"><?php $sql = 'SELECT * FROM payment_tbl WHERE Lname="'.$var_value.'"';
                    $result = mysqli_query($conn,$sql);
                    $resultCheck = mysqli_num_rows($result);
