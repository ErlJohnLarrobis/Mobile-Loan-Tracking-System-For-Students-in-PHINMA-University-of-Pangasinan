        ...
        <div class="col-md-12 mb-3">
          <div class="card">
            <div class="card-header">
              <span><i class="bi bi-pen-fill"></i></span> Change Password
            </div>
            <div class="card-body">
              <form class="form-login" action="change-p.php" method="post">
                <p class="error" style="background: #F2DEDE; color: #A94442; padding: 10px; width: 100%; border-radius: 5px;"><?php echo $_SESSION['msg1'];?><?php $_SESSION['msg1'] =""; ?></p>
    
                <div class="input-group mb-3">
                  <span class="input-group-text" id="inputGroup-sizing-default">Current Password</span>
                  <input name="op" type="password" placeholder="Current Password" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                  <span class="input-group-text" id="inputGroup-sizing-default">New Password</span>
                  <input name="np" type="password" placeholder="New Password" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                  <span class="input-group-text" id="inputGroup-sizing-default">Confirm Password</span>
                  <input name="c_np" type="password" placeholder="Confirm Password" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
